...
import { isOtherUser as isOther } from "../../../../useConfig.json";
			...
			<div className="menu-left">
				...
				<ul className="menuList">
					...
					>
						...
						<div
							className="menu-name"
							onClick={this.showNewsChildMenu.bind(this)}
						>
							{/* <NavLink
                                to={{
                                pathname: "/news"
						...
						<div className="childNewsMenu">
							...
							<span
								className={
									curchildmenu == "transactionbulletin"
										? "cur"
										: ""
								}
							>
					...
					{!isOther && (
						<li className={curmenu == "feedback" ? "cur" : ""}>
							<div className="menu-wallet menuicon" />
							<div className="menu-name">
								<NavLink
									to={{
